...
// SaveEmployee provides a mock function with given fields: ctx, identifier, fullname, shortname, position, email, phone, isAdmin
func (_m *EmployeeRepoIface) SaveEmployee(ctx context.Context, identifier int, fullname string, shortname string, position string, email string, phone string, isAdmin bool) error {
	ret := _m.Called(ctx, identifier, fullname, shortname, position, email, phone, isAdmin)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, int, string, string, string, string, string, bool) error); ok {
		r0 = rf(ctx, identifier, fullname, shortname, position, email, phone, isAdmin)
	} else {
		r0 = ret.Error(0)
	}
...
// UpdateEmployee provides a mock function with given fields: ctx, identifier, fullname, shortname, position, email, phone, isAdmin
func (_m *EmployeeRepoIface) UpdateEmployee(ctx context.Context, identifier int, fullname string, shortname string, position string, email string, phone string, isAdmin bool) error {
	ret := _m.Called(ctx, identifier, fullname, shortname, position, email, phone, isAdmin)
